...
export const loadGoogleAdsConfig = () => {
  const customerId = sanitizeCustomerId(requireEnv('GOOGLE_ADS_CUSTOMER_ID'))
  const loginCustomerId = sanitizeCustomerId(optionalEnv('GOOGLE_ADS_LOGIN_CUSTOMER_ID'))
  ...
  return {
    ...
    apiVersion: optionalEnv('GOOGLE_ADS_API_VERSION', 'v22'),
    defaultLandingUrl: optionalEnv('GOOGLE_ADS_DEFAULT_LANDING_URL', 'https://tiresiasview.com'),
  }
}
