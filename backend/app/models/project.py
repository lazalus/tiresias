"""
프로젝트 컨텍스트 관리
서버에서 프로젝트 상태를 영구화하여 프런트엔드가 인터페이스 간에 많은 데이터를 전달하는 것을 방지합니다.
"""
...
class Project:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'Project':
        ...
        return cls(
            ...
            planned_agents=data.get('planned_agents'),
            planned_rounds=data.get('planned_rounds'),
