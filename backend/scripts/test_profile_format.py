"""
프로필 형식 생성이 OASIS 요구 사항을 준수하는지 테스트합니다.

검증 항목:
1. 트위터 프로필 CSV 형식 생성
2. 레딧 프로필 JSON 상세 형식 생성
"""
...
def test_profile_formats():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        # 레딧 프로필 테스트 (JSON 상세 형식)
        print("\n2. 레딧 프로필 테스트 (JSON 상세 형식)")
        print("-" * 40)
